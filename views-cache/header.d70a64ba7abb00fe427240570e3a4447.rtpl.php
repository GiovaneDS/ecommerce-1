...
<head>
  ...
  <!--[if lt IE 9]>
  <script src="/res/admin//res/admin/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="/res/admin//res/admin/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
</head>
<!--
BODY TAG OPTIONS:
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="/res/admin/#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Jocemir</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Jocemir Roberto
                  <small>Membro desde Nov. 2019</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/res/admin/#" class="btn btn-default btn-flat">Perfil</a>
                </div>
